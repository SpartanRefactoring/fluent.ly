...
import il.org.spartan.utils.___.Bug.Assertion.Value.Numerical.*;
import il.org.spartan.utils.___.Bug.Assertion.Variant.*;
import il.org.spartan.utils.___.Bug.Contract.*;
 ...
 * @author Yossi Gil (
 * @since 11/01/2006) */
@Utility public abstract class ___ {
   ...
   * @param cond If <code><b>false</b></code>, method will not return and print
   *        error message.
   * @param kind A string describing an error kind, e.g., pre-condition failure
   * @param args Additional strings describing an error kind in a
  ...
  public static void warn(final String ¢) {
    System.out.println(¢);
  }
}